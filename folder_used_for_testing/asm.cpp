...
//type = 0 means no operand						
	Optab["add"] = {"06" , 0} ;	Optab["sub"] = {"07" , 0} ;	Optab["shl"] = {"08" , 0} ;
	Optab["shr"] = {"09" , 0} ;	Optab["a2sp"] = {"0B" , 0} ;	Optab["sp2a"] = {"0C" , 0} ;
	Optab["return"] = {"0E" , 0} ; Optab["halt"] = {"12" , 0} ;

//type = 1 means argument is given
	Optab["data"] = {"" , 1} ;	Optab["ldc"] = {"00" , 1} ;	Optab["adc"] = {"01" , 1} ;
	Optab["set"] = {"" , 1} ; Optab["adj"] = {"0A" , 1} ;

//type = 2 means offset to be given
	Optab["ldl"] = {"02" , 2} ;	Optab["stl"] = {"03" , 2} ;	Optab["ldnl"] = {"04" , 2} ;
	Optab["stnl"] = {"05" , 2} ; Optab["call"] = {"0D" , 2} ;	Optab["brz"] = {"0F" , 2} ;
	Optab["brlz"] = {"10" , 2} ;	Optab["br"] = {"11" , 2} ;
...
{	
    ...
    int i = 0;
    while(argv[1][i] != '.'){ namewithoutasm += argv[1][i];i++;}
